...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using chouh𝘼 𝘽O𝙏𝙎:\n\n"
        ...
        f"**If you have any questions, feel free to ask  chouh𝘼𝙉 𝘽𝙊𝙏𝙎🐦](https://t.me/+MdZ2996M2G43MWFl)! 💬**\n"
        )
    ) 
